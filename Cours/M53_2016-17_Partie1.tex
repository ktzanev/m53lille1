...
\begin{frame}{Le plan réel}
  \begin{itemize}[<+(1)->]
    \item Un ensemble $\ens{P}$ est un \myemph{plan} s'il est \frquote{naturellement} isomorphe à $\mathbb{R}^{2}$. Les éléments de $\ens{P}$ sont appelés des \myemph{points} ou des \myemph{vecteurs} en fonction du contexte.
