...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  \begin{frame}{Repère cartésien}
    ...
    \begin{definition}
      Soit $\mathcal{C}=(\Omega, \vv{v_{1}}, \ldots,\vv{v_{n}})$ un repère cartésien de $\ens{E}$ et $M$ un point de $\ens{E}$. On dit que $(x_{1},\ldots,x_{n})_{\mathcal{C}}$ sont les \alert{coordonnées cartésiennes} de $M$ dans le repère $\mathcal{C}$ si ceux sont les coordonnées de $\vv{\Omega M}$ dans la base $(\vv{v_{1}}, \ldots,\vv{v_{n}})$ de la direction $\ev{E}$.\pause\ Autrement dit $M=(x_{1},\ldots,x_{n})_{\mathcal{C}}$ si et seulement si $M=\Omega+\sum_{i=1}^{n}x_{i}\vv{v_{i}}$.
    \end{definition}
  \end{frame}
  % -----------
