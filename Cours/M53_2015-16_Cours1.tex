...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  \begin{frame}{Somme de sous-espaces affines}
    \begin{proposition}
      ...
      \begin{enumerate}[<+(1)->]
        \item Si $\ens{F} \cap \ens{G} \neq \emptyset$, alors $\left<\ens{F},\ens{G}\,\right>$ est de direction $\ev{F}+\ev{G}$\pause, et
            $$
              \dim\left<\ens{F},\ens{G}\,\right> = \dim \left(\ev{F}+\ev{G}\right).
            $$
        \item Si $\ens{F} \cap \ens{G} = \emptyset$, alors $\left<\ens{F},\ens{G}\,\right>$ est de direction $\ev{F}+\ev{G}+\vv{D}$, où $\vv{D}$ est une droite engendrée par $\vv{AB}$ avec $A \in \ens{F}$ et $B \in \ens{G}$\pause, et
            $$
              \dim\left<\ens{F},\ens{G}\,\right> = \dim \left(\ev{F}+\ev{G}\right)+1.
            $$
      \end{enumerate}
    \end{proposition}
  \end{frame}
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  \begin{frame}{Premières propriétés}
    ...
    \end{proposition}\pause
    \begin{proposition}
      Soit $\phi\in\Aff(\mathcal{E},\mathcal{F})$, $\mathcal{A} \subset \mathcal{E}$ et $\mathcal{B} \subset \mathcal{F}$.
      \begin{enumerate}
        \item $\phi(\mathcal{A})$ est un s.e.a. de $\mathcal{F}$ de direction $\vv\phi(\vv{\mathcal{A}})$.
        \item $\phi^{-1}(\mathcal{B})$ est vide ou un s.e.a. de $\mathcal{E}$ de direction $\vv\phi^{-1}(\vv{\mathcal{B}})$.
      \end{enumerate}
