...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  \begin{frame}{Les sous-espaces affines d'un espace vectoriel}
    ...
    \begin{itemize}[<+(1)->]
      ...
      \item $\ens{F}$ est un hyperplan affine ssi il existe une forme linéaire non nulle $\phi\in\vv{\ens{E}}^{\,*}$ et $a \in \mathbb{R}$, tels que $\ens{F}=\phi^{-1}(a)$.
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  \begin{frame}{Premières propriétés}
    ...
    \end{proposition}\pause
    \begin{proposition}
      Les images directes et inverses de sous-espaces affines par une application affine sont des sous-espaces affines ou vide.\pause\ Ainsi les images de trois points alignés sont alignées.
    \end{proposition}\pause
    \begin{proposition}
  ...
  \begin{frame}{Homothéties affines}
    ...
    \begin{enumerate}[<+(1)->]
      ...
      \item Une application affine est une homothétie affine non identité ssi sa partie vectorielle est une homothétie vectorielle non identité.
