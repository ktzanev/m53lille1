...
\begin{exo} (Caractérisation des homothéties-translations)
  ...
  Soient $\ens{E}$ un espace affine réel et $\varphi \in \aff(\ens{E})$ une application affine qui envoie toute droite de $\ens{E}$ sur une droite parallèle. Montrer que $\varphi$ est une translation où une homothétie non nulle.
\end{exo}
