...
\begin{solution}
  \begin{enumerate}
    ...
    \begin{minipage}[t]{.21\linewidth}~\\[14mm]
      \hspace*{\fill}
      \smash{\scalebox{.7}{\input{M53_2016-17_DS2_exo1_sol_a.tikz}}}
    \end{minipage}\\[3mm]
    ...
    \begin{minipage}[t]{.21\linewidth}~\\[21mm]
      \hspace*{\fill}
      \smash{\scalebox{.7}{\input{M53_2016-17_DS2_exo1_sol_b.tikz}}}
    \end{minipage}\\[2.1mm]
...
\begin{solution}
  ...
  \begin{minipage}[t]{.21\linewidth}~\\[21mm]
    \hspace*{\fill}
    \smash{\scalebox{.7}{\input{M53_2016-17_DS2_exo2_sol.tikz}}}
  \end{minipage}\\
  ...
  \begin{minipage}[t]{.21\linewidth}~\\[19mm]
    \hspace*{\fill}
    \smash{\scalebox{.77}{\input{M53_2016-17_DS2_exo2_sol2.tikz}}}
  \end{minipage}\\
...
\begin{exo} (Géométrie dans le plan complexe)
  ...
  \begin{enumerate}[resume]
    ...
    \begin{minipage}[t]{.42\linewidth}~\\[11mm]
      \hspace*{\fill}
      \smash{\scalebox{.7}{\input{M53_2016-17_DS2_exo4.tikz}}}
    \end{minipage}
  \end{enumerate}
...
\begin{solution}
  \begin{enumerate}
    ...
    \begin{center}
      \input{M53_2016-17_DS2_exo4_sol_a.tikz}
    \end{center}
    ...
    \begin{minipage}[t]{.28\linewidth}~\\[28mm]
      \hspace*{\fill}
      \smash{\scalebox{.7}{\input{M53_2016-17_DS2_exo4_sol_d.tikz}}}
    \end{minipage}\\[3mm]
